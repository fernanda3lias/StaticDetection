...
# Creating black mask + drawing white polygon on black mask
mask = np.zeros(background_image.shape[:2],
                dtype="uint8")
# Take same height and width as the image
#cv2.imshow('mask',mask)

# White: updating pts which is the area of interest
...
while (cap.isOpened()):
    ...
    # Creating a copy of the thresh to find contours
    ...
    # Drawing the area of interest on the frame
